...
myFunction_add3_and_squareit(1)
```
...
#The cause of the error for the chunk of code above is due to incorrect use of summarise() function in the small_n_cnt object. As a result, the mutate function to compute for the percentatge n/N resulted to non-numeric argument to binary operator.
```
